...
if __name__ == '__main__':
    ...
    parser.add_argument('-model', type=str, default='LSTM2LSTM', help="模型名称")
    ...
    parser.add_argument('-data_path', type=str, default='sf.csv', help="数据数据地址")
    parser.add_argument('-target', type=str, default='SapFlow', help='需要预测的特征列，这个值会最后保存在csv文件里')
    parser.add_argument('-input_size', type=int, default=10, help='特征个数不算时间那一列')
    ...
    # 滚动预测，需要有一个额外的文件和你的训练数据集完全相同但是数据时间点不同。
